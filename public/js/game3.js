...
function create() {
    ...
    snakeHead = game.add.sprite(1200, 1200, 'ball');
    ...
    {
        snakePath[i] = new Phaser.Point(1200, 1200);
    }
...
function update() {
    ...
    if (cursors.up.isDown)
    {
        ...
        {
            if (i === 1){
                snakeSection[i].alpha = 0;
                //snakeSection[i].x = (snakePath[i * snakeSpacer]).x + 50;
                //snakeSection[i].y = (snakePath[i * snakeSpacer]).y + 50;
            }
